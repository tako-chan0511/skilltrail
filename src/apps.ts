...
export const apps: App[] = [
  ...
  },
  {
    ...
    tags: ['Next.js', 'React', 'Canvas', 'GameDev', 'Hooks', 'Vite', 'TypeScript'],
    learnings: {
  ...
  },
  {
    ...
    features: [
      'Vue 3のリアクティブなデータによる盤面描画',
      '最後に置かれたコマを起点とする効率的な勝利判定アルゴリズム',
      '「一手戻す（Undo）」機能',
      'ゲームのリスタート機能',
    ],
    stack: [
  ...
  },
  {
    ...
    features: [
      'Vue 3のComposition APIによる複雑な状態管理',
      'HTML5 Drag and Drop APIによる直感的なカード操作',
      '「一手戻す」機能と、ゲームクリア時の「自動完了」機能',
      'ダブルクリックによる組札への自動移動',
    ],
    stack: [
      { name: 'Vue 3 (Composition API)', color: 'bg-green-200 text-green-800' },
      ...
      { name: 'Algorithm Design', color: 'bg-purple-200 text-purple-800' },
      { name: 'State Management', color: 'bg-red-200 text-red-800' },
      { name: 'Drag & Drop API', color: 'bg-yellow-200 text-yellow-800' },
    ],
  },
  {
    id: 27,
    ...
    features: [
      '1～10桁まで対応した動的なゲーム設定',
      '練習モードと、戦略的アルゴリズムを持つPC対戦モード',
      'Web Workerによるノンブロッキングな候補絞り込み計算',
      'localStorageによるゲーム履歴の永続化',
    ],
    stack: [
      { name: 'Vue 3 (Composition API)', color: 'bg-green-200 text-green-800' },
      { name: 'TypeScript', color: 'bg-blue-200 text-blue-800' },
      { name: 'Web Workers', color: 'bg-orange-300 text-orange-900' },
      { name: 'Algorithm Design', color: 'bg-purple-200 text-purple-800' },
      { name: 'Logic', color: 'bg-red-200 text-red-800' },
    ],
  },
  {
    ...
    features: [
      'VueからReact/Next.jsへのフレームワーク移植研究',
      'React Hooks (`useState`, `useMemo`) による状態管理',
      '`useMemo`による重い計算処理のメモ化・最適化',
      'localStorageへのゲーム履歴の永続化',
    ],
    stack: [
      { name: 'Next.js', color: 'bg-black text-white' },
      { name: 'React (Hooks)', color: 'bg-cyan-200 text-cyan-800' },
